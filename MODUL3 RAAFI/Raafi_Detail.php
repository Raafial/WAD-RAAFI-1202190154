...
<body>
 ...
 <?php
                        ...
                        <form action="Raafi_Detail.php?id_buku=<?php echo $row['id_buku'] ?>" method="post">
                            <div class="card-footer bg-transparent">
                                <p style="text-align: center;">
                                    ...
                                    <button type="submit" value="<?php echo $row['id_buku'] ?>" name="TAKIS" class="btn btn-danger">Hapus</button>
                                </p>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container mx-auto my-1">
                                    <form action="Raafi_Detail.php?id_buku=<?php echo $row['id_buku'] ?>" method="post" enctype="multipart/
                                        form-data">
                                        <div class="row">
 ...
 <?php
                                                                ...
                                                                <div class="row col-md-12">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($DAG1) ? 'checked' : ''; ?> type="checkbox" class="form-check-input" name="DAG[]" id="" value="Pemrograman">
                                                                            Pemrograman
                                                                        </label>
                                                                    </div>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="updateEvent" class="btn btn-primary">Simpan Perubahan</button>
                                </div>
                            </div>
                                                    </div>
                        </div>
