...
if (isset($_POST['updateEvent'])) {
  $judulbuku = $_POST['judul'];  $Penulis = $_POST['penulis'];  $TahunTerbit = $_POST['terbit'];  $Deskripsi = $_POST['desc'];  $bahasa = $_POST['Blas'];  $tag = json_encode($_POST['DAG']);  $id = $_POST['id_buku'];
